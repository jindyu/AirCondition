package com.ihris.aircondition
...
import com.ihris.aircondition.data.Repository
import com.ihris.aircondition.data.models.airquality.Grade
...
import com.ihris.aircondition.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
            ...
            .addOnSuccessListener { location ->
                scope.launch {
                    ...
                    try {
                        ...
                        val measureValue = Repository.getLatestAirQualityData(monitoringStation!!.stationName!!)
    ...
    fun displayAirQualityData(monitoringStation: MonitoringStation, measuredValue: MeasureValue){
        binding.contentsLayout.animate()
            .alpha(1F)
            .start()

        binding.measuringStationNameTextView.text = monitoringStation.stationName
        binding.measureingStationAddressTextView.text = monitoringStation.addr
        ...
        with(measuredValue){
            binding.findDustInformationTextView.text = "미세먼지: $pm10Value ㎍/㎥ ${(pm10Grade ?: Grade.UNKNOWN).emoji}"
